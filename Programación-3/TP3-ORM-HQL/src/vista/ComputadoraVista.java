...
public class ComputadoraVista extends javax.swing.JFrame {
    ...
    public ComputadoraVista() {
        try {
            ...
            List<Computadora> computadoras = gc.dameListaComputadorasHQL();
        ...
        try {
            if (filaSeleccionada == -1) {
                if (txtCodigo.getText().isEmpty() || txtMarca.getText().isEmpty() || txtModelo.getText().isEmpty()) {
                    ...
                    gc.insertarComputadoraHQL(txtCodigo.getText(), txtMarca.getText(), txtModelo.getText());
                    actualizarTabla();
                ...
                gc.editarComputadoraHQL(valorId, txtCodigo.getText(), txtMarca.getText(), txtModelo.getText());
                actualizarTabla();
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        try {
            if (filaSeleccionada == -1) {
                ...
                txtCodigo.setText(gc.dameComputadoraFilaHQL(valorId).getCodigo());
                txtMarca.setText(gc.dameComputadoraFilaHQL(valorId).getMarca());
                txtModelo.setText(gc.dameComputadoraFilaHQL(valorId).getModelo());
            }
        } catch (Exception ex) {
            Logger.getLogger(ComputadoraVista.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        try {
            if (filaSeleccionada == -1) {
                ...
                Long valorId = (Long) listaComputadoras.getValueAt(filaSeleccionada, 0);
                GestorComputadora gc = new GestorComputadora();
                gc.eliminarComputadoraHQL(valorId);
                actualizarTabla();
