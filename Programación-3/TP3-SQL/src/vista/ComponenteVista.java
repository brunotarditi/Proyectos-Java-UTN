...
public class ComponenteVista extends javax.swing.JFrame {
    ...
    public void llenaCombobox() {
        ...
        List<String> id_computadora = new GestorComponente().traeIdComputadora();
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        try {
            if (filaSeleccionada == -1) {
                ...
                txtNombre.setText(gc.dameComponenteFila(valorId).getNombre());
                txtSerie.setText(gc.dameComponenteFila(valorId).getNroSerie());
